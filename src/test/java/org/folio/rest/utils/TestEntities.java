...
public enum TestEntities {
  ...
  //Transactions will be created for budgets if allocated > 0
  TRANSACTION(HelperUtils.getEndpoint(FinanceStorageTransactions.class), Transaction.class, "data/transactions/", "payment.json", "source", "Voucher", 24),
